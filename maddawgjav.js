...
// @version      1.3.1.1
// @description  blogjav.net网站重新排版，基于Hobby版修改，浏览图片下载内容更方便，是时候和封面杀手说88了。
// @author       Zk
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        GM_addStyle(`
            ...
            .right {display:none;float: left;width: 185px;padding: 0px 0 0;margin-right: 0;}
            ...
            .max{width:100%;height:auto;max-width: none;padding-right:10px}
